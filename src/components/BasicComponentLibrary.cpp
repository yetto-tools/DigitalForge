...
PropertyDescriptor makeLabelProperty() {
...
PropertyDescriptor makeLabelRotationProperty() {
    return PropertyDescriptor{
        .id = "labelRotation",
...
PropertyDescriptor makeBodyColorProperty(std::string defaultHex) {
    return PropertyDescriptor{
        .id = "bodyColor",
...
PropertyDescriptor makeCustomWidthProperty() {
    return PropertyDescriptor{
        .id = "customWidth",
...
PropertyDescriptor makeCustomHeightProperty() {
    return PropertyDescriptor{
        .id = "customHeight",
...
PropertyDescriptor makeNotesProperty() {
    return PropertyDescriptor{
        .id = "notes",
        .displayName = "Notas",
